...
- dns
  ...
  ![image-20210505171618465](http://io.storyxc.com/image-20210505171618465.png)

  - 真机的ip信息

    ![image-20210505171651704](http://io.storyxc.com/image-20210505171651704.png)
...
- nginx
  ...
  - 安装后切换到/usr/local/nginx/sbin启动nginx并访问
    ...
    ![image-20210505174840552](http://io.storyxc.com/image-20210505174840552.png)
